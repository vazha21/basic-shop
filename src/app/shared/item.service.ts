...
export class ItemService {
  ...
  constructor() {
    this.items.set(1, new Item(1, 'Honda civic 2019', 'this car will serve u as a good friend', 500, 'fas fa-car'));
    this.items.set(2, new Item(2, 'Cooking book', 'This book is nice about cooks', 35, 'fas fa-book'));
  }
